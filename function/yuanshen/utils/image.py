...
from function.yuanshen.utils.path import FONTS_PATH
...
class PMImage:
    ...
    async def new(self, size: Tuple[int, int], color: Tuple[int, int, int] = (255, 255, 255), mode: str = 'RGBA'):
    ...
    async def resize(self, size: Union[float, Tuple[int, int]]):
        """
        缩放图片
            :param size: 缩放大小/区域
        """
    ...
    async def crop(self, box: Tuple[int, int, int, int]):
        """
        裁剪图像
            :param box: 目标区域
        """
    ...
    async def rotate(self, angle: float, expand: bool = False, **kwargs):
        """
        旋转图像
            :param angle: 角度
            :param expand: expand
    ...
    async def draw_rounded_rectangle(self,
                               pos: Tuple[int, int, int, int],
                               radius: int = 5,
                               color: Union[str, Tuple[int, int, int, int]] = 'white',
                               width: int = 1):
    ...
    async def draw_rounded_rectangle2(self,
                                pos: Tuple[int, int],
                                size: Tuple[int, int],
                                radius: int = 5,
                                color: Union[str, Tuple[int, int, int, int]] = 'white',
    ...
    async def to_circle(self, shape: str = 'rectangle'):
        """
        将图片转换为圆形
        """
        self.convert('RGBA')
    ...
    async def to_rounded_corner(self, radii: int = 30):
        """
        将图片变为圆角
            :param radii: 半径
        """
    ...
    async def add_border(self, border_size: int = 10, color: Union[str, Tuple[int, int, int, int]] = 'black',

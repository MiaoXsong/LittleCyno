...
yuanshen_logger = MyLogger(logger_name="yuanshen").get_logger()
news_60s_logger = MyLogger(logger_name="news_60s").get_logger()
chatgpt_logger = MyLogger(logger_name="chatgpt").get_logger()
